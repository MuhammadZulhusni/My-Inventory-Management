    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-hard overflow-hidden transition-all duration-300 hover:shadow-xl">
            ...
            <div class="bg-primary py-4 px-6 text-center">
                ...
                <h1 class="text-white text-xl font-bold mt-2">Inventory Management</h1>
                <p class="text-primary-light text-sm mt-1">Secure access to your inventory</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="p-6 space-y-6">
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-medium text-gray-700">
                        <i class="fas fa-user-circle mr-1 text-primary"></i> Username
                    </label>
                    <div class="relative">
            ...
            <div class="bg-gray-50 px-6 py-4 text-center border-t border-gray-100">
                <p class="text-xs text-gray-500">
                    <i class="fas fa-shield-alt mr-1 text-primary"></i> Secure login
                    &bull; 
                    <span class="text-primary font-medium">v{{ config('app.version', '1.0.0') }}</span>
                </p>
